...
import com.ebatashota.coroutineasync.viewmodel.AsyncSampleViewModel


class AsyncSampleFragment : Fragment() {

    private val viewModel: AsyncSampleViewModel by viewModels()
